<nav class="st-menu st-effect-4" id="menu-4">
		<div id="profile">
			<div class="picture"><img src="img/<?php getEmployee($userID, 'img') ?>" alt="profile" width="100"></div>
			<div class="name"><?php getEmployee($userID, 'name') ?></div>
			<div class="settings">View Profile & Settings</div>
		</div>
		<ul id="menu">
			<a href="index.php"><li><span class="icon-calendar menu-icon"></span></span>Home</li></a>
